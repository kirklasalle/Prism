...
**Author:** Kirk LaSalle  
**Tags:** #.mcp\impressioncore_goliath\server_old_fixed.py #documentation #python #source_code #testing #web_interface  
...
# MCP imports - must be after other imports to avoid conflicts
try:
        ...
        try:
            ...
            if bridge_name not in bridges:
                if TextContent:
                    ...
                    return [{"type": "text", "text": f"[ERROR] Bridge '{bridge_name}' not found. Available bridges: {list(bridges.keys())}"}]
