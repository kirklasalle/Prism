...
export const PROVIDER_PROMPT_STRATEGIES: readonly ProviderPromptStrategy[] = [
    ...
    // ── Anthropic Claude ──
    {
        ...
        notes: [
            ...
            "Claude 5-series: native agentic tool use and complex multi-step reasoning",
    ...
    // ── Google Gemini ──
    {
        ...
        notes: [
            ...
            "Temperature defaults to 1.0 for Gemini 3.x models — do not override without reason",
            "Gemini 3.7 Flash: workhorse for coding, agentic workflows, and complex tool-use",
    ...
    // ── xAI Grok (August 2026) ──
    {
        providerPattern: "^grok-|^xai/",
        label: "xAI Grok",
        structureFormat: "markdown",
        chainOfThoughtMode: "explicit",
        temperatureDefault: 0.3,
        ...
        maxSystemPromptTokens: 4000,
        notes: [
            "Use Markdown headers + concise bullet points for structured prompts",
            "Grok 4.6 supports configurable reasoning efforts (low, medium, high, xhigh)",
            "Optimized for long-running agentic tasks and professional coding sessions",
            "Supports 500K-2M token context windows across 4.x family",
            "OpenAI-compatible API format (Authorization Bearer token)",
        ],
    },
    // ── Cohere Command ──
    {
        providerPattern: "^command-|^cohere-",
        label: "Cohere",
        structureFormat: "markdown",
        chainOfThoughtMode: "explicit",
        temperatureDefault: 0.3,
        ...
        maxSystemPromptTokens: 4000,
        notes: [
            "Structured for agentic tool use and Retrieval-Augmented Generation (RAG)",
            "Command A+ is a 218B MoE model optimized for enterprise tool calling",
            "Use clear Markdown formatting with explicit tool definitions",
        ],
    },
...
const KNOWN_PROFILES: ModelCapabilityProfile[] = [
    ...
    // ---- Cloud: OpenAI — Legacy ----
    {
        ...
        deprecationReason: "Superseded by GPT-4o and subsequently GPT-5.6 family",
    },
    {
        pattern: "gpt-4-turbo",
        label: "GPT-4 Turbo",
    ...
    // ---- Cloud: OpenAI — GPT-4o (Deprecated Feb 2026, superseded by GPT-5.6) ----
    {
        pattern: "gpt-4o-mini",
        label: "GPT-4o Mini",
        tier: 3,
        ...
        locality: "cloud",
        deprecated: true,
        deprecatedAt: "2026-02-13",
        successor: "gpt-5.6-luna",
        deprecationReason: "GPT-4o retired from ChatGPT Feb 13, 2026; superseded by GPT-5.6 family",
    },
    {
    ...
    },
    {
        ...
        successor: "gpt-5.6-terra",
        deprecationReason: "Legacy GPT-4; superseded by GPT-4 Turbo, then GPT-4o, then GPT-5.6",
    },
    {
        pattern: "gpt-5-mini",
        label: "GPT-5 Mini",
    ...
    // ---- Cloud: OpenAI — GPT-5.6 Family (Released July–Aug 2026) ----
    {
        pattern: "gpt-5.6-sol",
        label: "GPT-5.6 Sol",
        tier: 5,
    ...
    },
    {
        ...
        successor: "gpt-5.6-sol",
        deprecationReason: "o3 series EOL'd Aug 26, 2026; API sunset Dec 2026. Use GPT-5.6 Sol with high reasoning effort.",
    },
    {
        pattern: "o3",
        label: "OpenAI o3",
        ...
        sunsetDate: "2026-12-31",
        successor: "gpt-5.6-sol",
        deprecationReason: "o3 EOL'd from ChatGPT Aug 26, 2026; API sunset Dec 2026. Use GPT-5.6 Sol with high reasoning effort.",
    },
    {
        pattern: "o3-mini",
    ...
    },
    {
        ...
        successor: "gpt-5.6-sol",
        deprecationReason: "o4-mini retired in 2026 as OpenAI consolidated toward GPT-5.6 architecture",
    },
    {
        pattern: "sora-2-pro",
        label: "Sora 2 Pro",
    ...
    // ---- Cloud: Anthropic — Claude 5-Series (Current, Released 2026) ----
    {
    ...
    },
    {
        ...
        modalities: ["text", "code", "image-understanding", "multimodal-reasoning"],
        locality: "cloud",
        // Note: Restricted-access / benchmark-tier model. May not be generally available via standard API.
    },
    // ---- Cloud: Anthropic — Claude 4-Series (Deprecated June 15, 2026) ----
    {
        ...
        deprecationReason: "Claude 4-series retired June 15, 2026. Migrate to Claude 5-series.",
    },
    {
    ...
    },
    {
        ...
        modalities: ["text", "code", "image-understanding"],
        locality: "cloud",
        // Note: Haiku 4.5 is maintained from previous generation for high-speed tasks.
    },
    // ---- Cloud: Anthropic — Legacy (Deprecated) ----
    {
        ...
        deprecationReason: "Pre-4 legacy model. Migrate to Claude Haiku 4.5 or Claude 5-series.",
    },
    {
        ...
        deprecatedAt: "2026-06-15",
        successor: "claude-sonnet-5",
        deprecationReason: "Pre-4 legacy model. Migrate to Claude 5-series.",
    },
    {
    ...
    // ---- Cloud: Google — Current (Aug 2026) ----
    {
        ...
        maxOutputTokens: 32768,
        adaptivePromptBudget: 6000,
        strengths: ["instruction-following", "reasoning", "code", "fast", "long-context", "tool-use", "agentic"],
    ...
    },
    {
        ...
        modalities: ["text", "code", "image-understanding", "video-understanding", "video-generation", "multimodal-reasoning"],
        locality: "cloud",
    },
    {
        pattern: "gemini-3.5-transcribe",
    ...
    // ---- Cloud: xAI / Grok Family (August 2026) ----
    {
        pattern: "grok-4.6",
        label: "Grok 4.6",
        tier: 5,
    ...
    },
    {
        ...
        maxOutputTokens: 16384,
        adaptivePromptBudget: 6000,
        strengths: ["instruction-following", "reasoning", "code", "long-context"],
        modalities: ["text", "code", "image-understanding"],
        locality: "cloud",
    },
    {
    ...
    // ---- Cloud: Meta — Llama 4 & Muse (2025–2026) ----
    {
        pattern: "llama-4-scout",
        label: "Llama 4 Scout",
        tier: 4,
        parameterSize: "frontier",
        parametersBillions: 109,
    ...
    // ---- Cloud: DeepSeek (V3 & V4) ----
    {
        pattern: "deepseek-v4-pro",
        label: "DeepSeek V4 Pro",
        tier: 5,
        parameterSize: "frontier",
        parametersBillions: 1600,
        contextWindow: 1000000,
        estimatedVramMb: 0,
        maxOutputTokens: 32768,
        adaptivePromptBudget: 8000,
        strengths: ["instruction-following", "reasoning", "code", "agentic", "long-context", "tool-use"],
        modalities: ["text", "code"],
        locality: "cloud",
    },
    {
        ...
        tier: 4,
        parameterSize: "frontier",
        parametersBillions: 284,
        contextWindow: 1000000,
        estimatedVramMb: 0,
        maxOutputTokens: 16384,
        adaptivePromptBudget: 4000,
        strengths: ["instruction-following", "reasoning", "code", "fast", "long-context"],
        modalities: ["text", "code"],
        locality: "cloud",
    },
    {
    ...
    },
    {
        ...
        maxOutputTokens: 16384,
        adaptivePromptBudget: 4000,
        strengths: ["code", "instruction-following", "fast"],
        modalities: ["text", "code"],
        locality: "cloud",
    },
    {
    ...
    {
        pattern: "pixtral-large",
        label: "Pixtral Large",
        tier: 4,
        parameterSize: "frontier",
        parametersBillions: 124,
        contextWindow: 128000,
        estimatedVramMb: 0,
        maxOutputTokens: 8192,
        adaptivePromptBudget: 4000,
        strengths: ["instruction-following", "multimodal", "reasoning"],
        modalities: ["text", "code", "image-understanding"],
        locality: "cloud",
    },
    {
    ...
    // ---- Cloud: Qwen (Alibaba Cloud) ----
    {
        pattern: "qwen3.8-max",
        label: "Qwen 3.8 Max",
        tier: 5,
        parameterSize: "frontier",
        parametersBillions: 2400,
        contextWindow: 262144,
        estimatedVramMb: 0,
        maxOutputTokens: 16384,
        adaptivePromptBudget: 6000,
    ...
    // ---- Cloud: Cohere ----
    {
        ...
        tier: 4,
        parameterSize: "frontier",
        parametersBillions: 218,
        contextWindow: 256000,
        estimatedVramMb: 0,
        maxOutputTokens: 16384,
        adaptivePromptBudget: 4000,
        strengths: ["instruction-following", "reasoning", "tool-use", "agentic", "multilingual"],
        modalities: ["text", "code", "image-understanding"],
        locality: "cloud",
    },
    {
        ...
        maxOutputTokens: 4096,
        adaptivePromptBudget: 3000,
        strengths: ["instruction-following", "reasoning", "tool-use", "long-context", "multilingual"],
        modalities: ["text", "code"],
        locality: "cloud",
    },
    {
    ...
    {
        pattern: "cohere/command-a-plus",
        label: "Command A+ (OpenRouter)",
        tier: 4,
        parameterSize: "frontier",
        parametersBillions: 218,
        contextWindow: 256000,
...
export function getModelFamily(modelName: string): string {
    ...
    if (lower.includes("cohere") || lower.includes("command") || lower.includes("north-mini")) return "cohere";
