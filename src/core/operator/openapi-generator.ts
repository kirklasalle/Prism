...
export function generateOpenApiSpec(port: number = 7070): OpenApiSpec {
    ...
    return {
        ...
        info: {
            ...
            version: "0.2.0",
            description:
                "The Prism Frontier Operator Console API provides endpoints for managing chat sessions, LLM providers, tools, agents, telemetry, and system governance.",
        },
...
function getKnownEndpoints(): EndpointDef[] {
    return [
        ...
        },
        {
            ...
            summary: "Terminal and container adapter status",
            tags: ["System"],
        ...
        // ── Provider & LLM ──
        {
            ...
            summary: "LLM provider catalog and active selection",
            tags: ["Providers"],
        },
        {
            path: "/api/providers",
        ...
        {
            path: "/api/providers/{providerId}/settings",
            method: "PUT",
        ...
        {
            path: "/api/providers/{providerId}/apikey",
            method: "PUT",
        ...
        {
            path: "/api/providers/{providerId}/discover",
            method: "POST",
        ...
        // ── Tools & Plugins ──
        {
            ...
            summary: "List registered tools with state",
            tags: ["Tools"],
        },
        {
            path: "/api/tools/{toolName}/toggle",
            method: "POST",
        ...
        {
            path: "/api/plugins/{name}/health",
            method: "GET",
            operationId: "getPluginHealth",
            summary: "Per-plugin health status",
            tags: ["Tools"],
        },
        {
            path: "/api/tools/{toolName}/test",
            method: "POST",
        ...
        // ── Telemetry ──
        {
            ...
            summary: "Telemetry summary for the selected window",
            tags: ["Telemetry"],
            queryParams: [
                {
                    name: "window",
                    required: false,
                    schema: { type: "string", enum: ["1h", "1d", "7d"] },
                    description: "Telemetry window",
                },
            ],
        },
        {
            ...
            summary: "Correlated trace summaries",
            tags: ["Telemetry"],
            queryParams: [
        ...
        {
            path: "/api/telemetry/slo-summary",
            method: "GET",
            operationId: "getSloSummary",
            summary: "SLO summary across the configured window",
            tags: ["Telemetry"],
        },
        ...
        // ── Actions ──
        {
            ...
            summary: "List dashboard actions and their states",
            tags: ["Actions"],
        },
        {
            path: "/api/actions/{name}/run",
            method: "POST",
            operationId: "runAction",
            summary: "Trigger a dashboard action",
            tags: ["Actions"],
        },
        {
        ...
        },
        {
            ...
            summary: "Guardian agent status",
            tags: ["Agentic"],
        },

        // ── Scheduler ──
        {
            path: "/api/scheduler/events",
            method: "GET",
            operationId: "listSchedulerEvents",
        ...
        },
        {
            path: "/api/scheduler/events",
            method: "POST",
            operationId: "createSchedulerEvent",
        ...
        // ── Incidents ──
        {
            path: "/api/incidents/bundle",
            method: "POST",
            operationId: "captureIncidentBundle",
            summary: "Capture an incident triage bundle",
            tags: ["Incidents"],
        },

        // ── Session Packages ──
        {
            path: "/api/session-packages",
            method: "GET",
            operationId: "listSessionPackages",
            summary: "List session packages",
            tags: ["Packages"],
        },
        {
            path: "/api/session-packages",
            method: "POST",
            operationId: "createSessionPackage",
        ...
        // ── OAuth ──
        {
            ...
            summary: "Gmail and Outlook OAuth connection status",
            tags: ["OAuth"],
        },
        ...
        // ── Models ──
        {
            path: "/api/models/gguf",
            method: "GET",
            operationId: "listGgufModels",
            summary: "List available GGUF models",
            tags: ["Models"],
        },
        {
        ...
        {
            path: "/api/models/download/status",
            method: "GET",
            operationId: "getDownloadStatus",
            summary: "Download progress status",
            tags: ["Models"],
        },
        {
            ...
            summary: "Delete a downloaded model or Ollama tag",
            tags: ["Models"],
        },
    ];
}
    ...
    return {
        ...
        AdaptersResponse: {
            ...
            properties: {
                ...
                container: {
                    type: "object",
                    properties: { enabled: { type: "boolean" }, backend: { type: "string" } },
                },
            },
        },
        ChatSessionSummary: {
