...
export const SR_HEMISPHERE_PROFILES: Record<string, HemisphereProfile> = {
    ...
    "creative-writing": {
        ...
        role: "creative",
        systemPrompt:
            "You are a creative-writing hemisphere. Produce vivid, emotionally resonant prose. Vary sentence rhythm. Show, don't tell. Honor the requested voice/style. Avoid clichés and AI-tell phrasing. If the user asks for fiction, stay in the chosen POV.",
        requiredStrengths: [],
        recommendedTimeoutMs: 90_000,
    },
    "research-synthesis": {
    ...
    "reasoning-deep": {
        ...
        role: "logic",
        systemPrompt:
            "You are a deep-reasoning hemisphere. Decompose the problem into sub-questions before answering. For each sub-question: state assumptions, derive conclusion, mark confidence (0.0–1.0). End with a consolidated answer that flags the lowest-confidence sub-step. Tier 4+ models recommended.",
    ...
    summarization: {
        ...
        role: "logic",
        systemPrompt:
            "You are a summarization hemisphere. Produce a faithful, lossy-but-balanced summary at the requested length. Preserve numeric facts, names, and dates verbatim. Do not add interpretation or value judgments. Output: bullet list, then a one-paragraph executive summary.",
        requiredStrengths: [],
