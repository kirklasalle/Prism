...
function buildDemoDefinitions(): DemoDefinition[] {
    const baseDefs: DemoDefinition[] = [
        // ═══ INDIVIDUAL OPERATOR TASKS (everyday consumer requests) ═══
        {
            id: "individual-jeans",
            title: "Individual: Shop for Jeans",
            category: "browser-control",
            icon: "👖",
            description:
                "A realistic Individual request: find a pair of jeans by size, brand, fit, and budget. Prism composes a shopping brief and a research plan you can act on.",
            prompts: [
                {
                    id: "jeans_size",
                    label: "What's your jeans size (waist × inseam)?",
                    description: "Pick the size to shop for.",
                    options: ["30x30", "32x30", "32x32", "34x32", "36x34"],
                    defaultValue: "32x32",
                },
                {
                    id: "jeans_brand",
                    label: "Preferred brand?",
                    description: "Denim brand to prioritize (or no preference).",
                    options: ["Levi's", "Wrangler", "Lee", "Carhartt", "Gap", "No preference"],
                    defaultValue: "Levi's",
                },
                {
                    id: "jeans_style",
                    label: "Fit / style?",
                    description: "The cut you want.",
                ...
                },
                {
                    id: "jeans_budget",
                    label: "Budget?",
                    description: "Price range per pair.",
                    options: ["Under $40", "$40-$80", "$80-$120", "No limit"],
                    defaultValue: "$40-$80",
                },
            ],
            steps: [
                {
                    id: "ij-1",
                    narration: "Framing the request: {{jeans_brand}} {{jeans_style}} denim jeans, size {{jeans_size}}, budget {{jeans_budget}}...",
                    action: "tab:chat",
                    args: {},
                    automated: true,
                },
                {
                    id: "ij-2",
                    narration: "Writing a shopping brief to prism-output/ so you can find it in the workspace...",
                    action: "tool:file_write",
                    args: {
                        path: "./prism-output/individual-jeans-brief.md",
                        content:
                            "# Shopping Brief - Jeans\n\n" +
                            "Generated by Prism Refraction (Individual profile) at {{timestamp}}.\n\n" +
                            "## Request\n" +
                            "- Item: Denim jeans (pants)\n" +
                            "- Size (waist x inseam): {{jeans_size}}\n" +
                            "- Brand: {{jeans_brand}}\n" +
                            "- Fit / style: {{jeans_style}}\n" +
                            "- Budget: {{jeans_budget}}\n\n" +
                            "## Research plan\n" +
                            "1. Search retailers for '{{jeans_brand}} {{jeans_style}} jeans {{jeans_size}}'.\n" +
                            "2. Filter to in-stock listings within {{jeans_budget}}.\n" +
                            "3. Compare price, return policy, and customer rating.\n" +
                            "4. Shortlist the top 3 and capture direct product links.\n\n" +
                            "## Next step\n" +
                            "Ask Prism: 'Find {{jeans_brand}} {{jeans_style}} jeans in {{jeans_size}} under {{jeans_budget}} and list 3 links.'\n",
                    },
                    automated: true,
                },
                {
                    id: "ij-3",
                    narration: "Brief saved. Switching to Logs to show the audit trail...",
                    action: "tab:logs",
                    args: {},
                    automated: true,
                },
        ...
        {
            id: "individual-car",
            title: "Individual: Find a Car to Buy",
            category: "browser-control",
            icon: "🚗",
            description:
                "A realistic Individual request: find a car by type, budget, and model-year range. Prism composes a buying brief and a research plan.",
            prompts: [
                {
                    id: "car_type",
                    label: "What kind of car?",
                    description: "Body style / powertrain.",
                    options: ["Sedan", "SUV", "Truck", "EV", "Hybrid", "Minivan"],
                    defaultValue: "SUV",
                },
                {
                    id: "car_budget",
                    ...
                    options: ["Under $10,000", "$10,000-$20,000", "$20,000-$35,000", "$35,000-$50,000", "No limit"],
                    defaultValue: "$20,000-$35,000",
                },
                {
                    id: "car_year_from",
                    label: "Oldest acceptable model year?",
                    description: "Start of the year range.",
                ...
                },
                {
                    ...
                    description: "End of the year range.",
            ...
            steps: [
                {
                    id: "ic-1",
                    narration: "Framing the request: {{car_type}}, {{car_budget}}, model years {{car_year_from}}-{{car_year_to}}...",
                    action: "tab:chat",
                    args: {},
                    automated: true,
                },
                {
                    id: "ic-2",
                    narration: "Writing a car-buying brief to prism-output/...",
                    action: "tool:file_write",
                    args: {
                        path: "./prism-output/individual-car-brief.md",
                        content:
                            "# Buying Brief - Car\n\n" +
                            "Generated by Prism Refraction (Individual profile) at {{timestamp}}.\n\n" +
                            "## Request\n" +
                            ...
                            "- Budget: {{car_budget}}\n" +
                            "- Model-year range: {{car_year_from}} to {{car_year_to}}\n\n" +
                            "## Research plan\n" +
                            "1. Search marketplaces for '{{car_type}} {{car_year_from}}-{{car_year_to}}' within {{car_budget}}.\n" +
                            "2. Filter by mileage, clean title, and seller rating.\n" +
                            "3. Compare total cost of ownership (insurance, fuel/charging, maintenance).\n" +
                            "4. Shortlist the top 3 and capture direct listing links.\n\n" +
                            "## Next step\n" +
                            "Ask Prism: 'Find a {{car_type}} from {{car_year_from}}-{{car_year_to}} under {{car_budget}} and list 3 listings.'\n",
                    },
                    automated: true,
                },
                {
        ...
        },
        {
            ...
            title: "Individual: Rent a Place to Live",
            category: "browser-control",
            icon: "🏠",
            description:
                "A realistic Individual request: find a rental by location, monthly budget, and bedroom count. Prism composes a rental brief and a research plan.",
            prompts: [
                {
                    id: "rent_location",
                    label: "Where do you want to live?",
                    description: "Target city or 'remote / flexible'.",
                    options: ["Austin, TX", "Denver, CO", "Seattle, WA", "Miami, FL", "Remote / flexible"],
                    defaultValue: "Austin, TX",
                },
                {
                    id: "rent_budget",
                    label: "Monthly rent budget?",
                    description: "How much you can spend per month.",
                    options: ["Under $1,200/mo", "$1,200-$1,800/mo", "$1,800-$2,500/mo", "$2,500+/mo"],
                    defaultValue: "$1,200-$1,800/mo",
                },
                {
                    id: "rent_bedrooms",
                    ...
                    defaultValue: "2 bedrooms",
                },
            ],
            steps: [
                {
                    id: "ir-1",
                    narration: "Framing the request: {{rent_bedrooms}} in {{rent_location}}, budget {{rent_budget}}...",
                    action: "tab:chat",
                    args: {},
                    automated: true,
                },
                {
                    id: "ir-2",
                    narration: "Writing a rental brief to prism-output/...",
                    action: "tool:file_write",
                    args: {
                        path: "./prism-output/individual-rental-brief.md",
                        content:
                            "# Rental Brief - Place to Live\n\n" +
                            "Generated by Prism Refraction (Individual profile) at {{timestamp}}.\n\n" +
                            "## Request\n" +
                            ...
                            "## Research plan\n" +
                            "1. Search rental listings for '{{rent_bedrooms}} {{rent_location}}' within {{rent_budget}}.\n" +
                            "2. Filter by pet policy, lease length, and availability date.\n" +
                            "3. Compare rent, deposit, utilities, and commute.\n" +
                            "4. Shortlist the top 3 and capture direct listing links.\n\n" +
                            "## Next step\n" +
                            "Ask Prism: 'Find a {{rent_bedrooms}} rental in {{rent_location}} under {{rent_budget}} and list 3 listings.'\n",
                    },
                    automated: true,
                },
                {
