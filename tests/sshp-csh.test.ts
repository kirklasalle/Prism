...
describe("SSHP Interceptor & CSH Manager Test Suite", function () {
    ...
    describe("SSHPInterceptor", () => {
        ...
        it("audits actions and enforces Sacred Covenant protections", async () => {
            ...
            const fileNav = await interceptor.auditAction("navigate", {
                sessionId: "sess-1",
                url: "file:///etc/passwd",
            });
            ...
            const evalDestructive = await interceptor.auditAction("evaluate", {
                sessionId: "sess-1",
    ...
    describe("CSHManager", () => {
        ...
        it("deserializes state back into a running Page and Context", async () => {
            ...
            const restored = await cshManager.deserialize(
